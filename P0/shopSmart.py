...
def shopSmart(orderList, fruitShops):
    ...
    # *** Your Code Here ***
    bestShop = None         # init value 
    lowestCost = 100        # set to high intial value
    totalCost = 0           # init value

    # each shop in list
    for Shops in fruitShops:
        # Call function to get price for that shop
        totalCost = Shops.getPriceOfOrder(orderList)
        # if better price 
        if totalCost < lowestCost:
            # Set best shop to buy and new lowest cost
            bestShop = Shops
